...
\section{Algorithms}
This project will compare three supervised learning algorithms\cite{comparing2012} and potentially a state-of-the-art technique. The three benchmarking algorithms are:
\begin{description}
...
There are several possibilities for state-of-the-art techniques to test for this task. An obvious choice would be Convoluted Neural Networks which, according to the KITTI leaderboard, perform very well on this task\cite{imagenet2012, deep2014}. Further research will be required to find a complex algorithm that remains within the scope of this course.
